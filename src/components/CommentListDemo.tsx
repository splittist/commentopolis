...
const sampleComments: DocumentComment[] = [
  {
    ...
    plainText: 'We should consider the budget implications of this proposal. The current estimates might be too optimistic given the market conditions. #budget #review',
    content: '<p>We should consider the budget implications of this proposal. The current estimates might be too optimistic given the market conditions. #budget #review</p>',
  ...
  },
  {
    ...
    plainText: 'Great point about the timeline. However, I think we can accelerate the delivery if we prioritize the core features first. #timeline #priority',
    content: '<p>Great point about the timeline. However, I think we can accelerate the delivery if we prioritize the core features first. #timeline #priority</p>',
    documentId: 'demo-doc1',
  ...
  },
  {
    ...
    plainText: 'The technical architecture looks solid, but we need to ensure compatibility with our existing systems. #technical #review',
    content: '<p>The technical architecture looks solid, but we need to ensure compatibility with our existing systems. #technical #review</p>',
  ...
  },
  {
    ...
    plainText: 'I agree with the risk assessment. We should add more contingency measures for the high-risk items. #risk #urgent',
    content: '<p>I agree with the risk assessment. We should add more contingency measures for the high-risk items. #risk #urgent</p>',
    documentId: 'demo-doc2',
  ...
  },
  {
    ...
    plainText: 'This section needs more detail. Can we expand on the implementation strategy? #implementation #urgent',
    content: '<p>This section needs more detail. Can we expand on the implementation strategy? #implementation #urgent</p>',
    documentId: 'demo-doc1',
  ...
  },
  {
    ...
    plainText: 'Good point Sarah. I\'ve reviewed the latest market data and agree we should be more conservative. Let me update the projections. #budget',
    content: '<p>Good point Sarah. I\'ve reviewed the latest market data and agree we should be more conservative. Let me update the projections. #budget</p>',
    documentId: 'demo-doc1',
    reference: 'Page 2, Paragraph 3',
  ...
  },
  {
    ...
    plainText: 'I can help with the compatibility testing. Let\'s schedule a technical review meeting. #technical',
    content: '<p>I can help with the compatibility testing. Let\'s schedule a technical review meeting. #technical</p>',
    documentId: 'demo-doc2',
    reference: 'Section 4.2',
